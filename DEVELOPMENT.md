...
| `EPP_IMAGE` | `ghcr.io/llm-d/llm-d-router-endpoint-picker:main` | EPP image loaded into the Kind cluster |
...
| `SIDECAR_IMAGE` | `ghcr.io/llm-d/llm-d-router-disagg-sidecar:main` | Routing sidecar image loaded into the Kind cluster |
