...
func (b *InferenceObjectiveSpecApplyConfiguration) WithPoolSelector(value *metav1.LabelSelectorApplyConfiguration) *InferenceObjectiveSpecApplyConfiguration {
