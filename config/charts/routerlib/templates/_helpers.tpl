...
{{- if and (eq (include "llm-d-router.priorityRouting.enabled" .) "true") (ne (include "llm-d-router.proxyMode" .) "service") -}}
...
{{- if and (eq (include "llm-d-router.priorityRouting.enabled" .) "true") (hasKey $eppFlags "health-checking") (not (index $eppFlags "health-checking")) -}}
