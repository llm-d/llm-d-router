...
- Response headers listed in the pipeline's `forward_response_headers` allowlist are copied from each upstream phase into later requests. This can carry EPP-stamped revision and topology metadata across encode, prefill, and decode.
