...
go test -tags=e2e ./test/coordinator/real-vllm-e2e/...

# Verbose output
go test -tags=e2e -v ./test/coordinator/real-vllm-e2e/...

# Only render tests
go test -tags=e2e -v -run TestE2E_ChatCompletions ./test/coordinator/real-vllm-e2e/...
go test -tags=e2e -v -run TestE2E_Completions ./test/coordinator/real-vllm-e2e/...

# Only encode tests
go test -tags=e2e -v -run TestE2E_Encode ./test/coordinator/real-vllm-e2e/...

# Only prefill tests
go test -tags=e2e -v -run TestE2E_Prefill ./test/coordinator/real-vllm-e2e/...

# Single test
go test -tags=e2e -v -run TestE2E_Encode_RenderThenEncode ./test/coordinator/real-vllm-e2e/...
...
- **No tests run with `go test ./test/coordinator/real-vllm-e2e/...`** — you forgot
