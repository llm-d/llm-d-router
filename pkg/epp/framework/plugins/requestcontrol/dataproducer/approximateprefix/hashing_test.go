...
func TestGetContentBlocks(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			expectedContentBlocks: []HashBlock{
				{PseudoTokens: append([]byte("system\x00\x00"), repeatBytes(imageHashBytes("data:image/jpeg;base64,bm90IGFuIGltYWdl"), 3)...)},
			},
			expectErr: false,
		},
		{
		...
		},
		{
			...
			expectedContentBlocks: []HashBlock{
				...
				{PseudoTokens: repeatBytes(imageHashBytes(base64Image180p1), 16)},
				{PseudoTokens: repeatBytes(imageHashBytes(base64Image180p1), 11)},
			},
			expectErr: false,
		},
		{
			...
			expectedContentBlocks: []HashBlock{
				...
				{PseudoTokens: repeatBytes(imageHashBytes(base64Image180p1), 16)},
				{PseudoTokens: repeatBytes(imageHashBytes(base64Image180p1), 16)},
				{PseudoTokens: append(append(repeatBytes(imageHashBytes(base64Image180p1), 11), []byte("aaaaaa\x00\x00")...), repeatBytes(imageHashBytes(base64Image180p2), 3)...)},
				{PseudoTokens: repeatBytes(imageHashBytes(base64Image180p2), 16)},
				{PseudoTokens: repeatBytes(imageHashBytes(base64Image180p2), 16)},
				{PseudoTokens: repeatBytes(imageHashBytes(base64Image180p2), 16)},
				{PseudoTokens: repeatBytes(imageHashBytes(base64Image180p2), 7)},
			},
			expectErr: false,
		},
		{
