...
is still loading and see it as absent. At the request rates measured (up to 0.6 req/s per
adapter) that window did not produce extra loads; a rendezvous-hash placement bonus built for it
was ablated out with no measurable effect.
