...
func TestRecordDisaggDecision(t *testing.T) {
	...
	RecordDisaggDecision("test-plugin", "test-type", model, DecisionTypeEncodePrefillDecode)
	RecordDisaggDecision("test-plugin", "test-type", model, DecisionTypeEncodePrefillDecode)
	RecordDisaggDecision("test-plugin", "test-type", model, DecisionTypeAggregatedFallback)
	...
	expected := `
		...
		llm_d_inference_scheduler_disagg_decision_total{decision_type="aggregated-fallback",model_name="test-model"} 1
	...
	expectedNew := `
		...
		llm_d_epp_disagg_decision_total{decision_type="aggregated-fallback",model_name="test-model",plugin_name="test-plugin",plugin_type="test-type"} 1
