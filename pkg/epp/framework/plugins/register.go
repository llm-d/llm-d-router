...
import (
	...
	"github.com/llm-d/llm-d-inference-scheduler/pkg/epp/framework/plugins/scheduling/scorer/prefetch"
...
func RegisterAllPlugins() {
	...
	plugin.Register(prefetch.PrefetchPrerequestHandlerType, prefetch.PluginFactory)
